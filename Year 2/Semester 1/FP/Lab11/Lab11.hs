...
instance Eq Person where
  (Person n1 a1) == (Person n2 a2) = (a1 == a2)

-- main = print (Person "Alice" 25) -- Name: Alice, Age: 25
-- main = print $ (Person "Alice" 30) == (Person "Bob" 30) -- True
...
-- data BTree a = Leaf a | Node (Tree a) (Tree a)
...
data Employee = Employee {empName:: String, empAge :: Int, empAddress :: String}
...
instance Show Employee where
  show (Employee enN enA emA) = "Name: " ++ enN ++ ", Age: " ++ (show emA) ++ ", Address: " ++ emA

-- bob:: Employee
bob = Employee {empName = "Bob", empAge = 40, empAddress = "London (SW1A 1AA)"}
...
data Daysofwk = Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday

instance Show Daysofwk where
  show Sunday = "Sunday"
  show Monday = "Today is Monday"
  show Tuesday = "Today is Tuesday"
  show Wednesday = "Today is Wedneaday"
  show Thursday = "Today is Thursday"
  show Friday =  "Today is Friday"
  show Saturday =  "Today is Saturday"


instance Eq Daysofwk where
  Sunday == Sunday = True
  Monday == Monday = True
